...
for i = 1:npar
  for j = i:npar
    if(abs(mcor(i,j)) > 0.75 & abs(mcor(i,j)) < 1.0)
      a(k,:) = [i j];
      mcorplot(k)=mcor(i,j);
      k = k + 1;
    end
...
ylabels = fliplr({'h1','g1','kg1','n1','t1','ks1','h2','g2','kg2','n2','t2','ks2',...
                  'h3','g3','kg3','n3','t3','ks3','h4','g4','kg4','n4','t4','ks4','h5','g5','kg5','n5','t5','ks5'});
xlabels = {'h1','g1','kg1','n1','t1','ks1','h2','g2','kg2','n2','t2','ks2',...
                  'h3','g3','kg3','n3','t3','ks3','h4','g4','kg4','n4','t4','ks4','h5','g5','kg5','n5','t5','ks5'};
