function [] = reformat_s19();

outfile  = strcat('x_s19_1_8_25_0lay.mat');
outfilea = strcat('x_s19_1_8_25_0lay.txt');
outfile2  = strcat('x_s19_1_8_25_0lay2.mat');
...
maxlim = [1.76, 1550, 1550, 1.6, 1.8, 1.500, 1.500];

%minlim = [0.5, 1450, 1450, 1.2, 1.3, 0.001, 1450, 1.2, 0.001];
%maxlim = [1.76, 1550, 1550, 1.6, 1.8, 1.500, 1550, 1.8, 1.500];
