...
i_resamp  = 1;  % Resample to even angle spacing 
...
%freq,frbw,freq_low,freq_up,cnmo,t0,rmx] = sim_A2_1_4_16_3lay_geo();

%[trial,fileroot,fileroot2,fileext,zs,zr,F,nang_re, ...
%freq,frbw,freq_low,freq_up,cnmo,t0,rmx] = sim_A_4_16_6lay_geo();

%[trial,fileroot,fileroot2,fileext,zs,zr,F,nang_re, ...
%freq,frbw,freq_low,freq_up,cnmo,t0,rmx] = s01_1_broad_geo();

%[trial,fileroot,fileroot2,fileext,zs,zr,F,nang_re, ...
%freq,frbw,freq_low,freq_up,cnmo,t0,rmx] = s01_1_3_20_2layrg_geo();

%[trial,fileroot,fileroot2,fileext,zs,zr,F,nang_re, ...
%freq,frbw,freq_low,freq_up,cnmo,t0,rmx] = s02_1_3_16_7lay_geo();

%[trial,fileroot,fileroot2,fileext,zs,zr,F,nang_re, ...
%freq,frbw,freq_low,freq_up,cnmo,t0,rmx] = s04_1_3_20_2lay_geo();

[trial,fileroot,fileroot2,fileext,zs,zr,F,nang_re, ...
freq,frbw,freq_low,freq_up,cnmo,t0,rmx] = s13_2_10_50_6lay_geo();

%[trial,fileroot,fileroot2,fileext,zs,zr,F,nang_re, ...
%freq,frbw,freq_low,freq_up,cnmo,t0,rmx] = s16_1_10_40_4lay_geo();

%[trial,fileroot,fileroot2,fileext,zs,zr,F,nang_re, ...
%freq,frbw,freq_low,freq_up,cnmo,t0,rmx] = s16_1_5_40_6layrg_geo();

%[trial,fileroot,fileroot2,fileext,zs,zr,F,nang_re, ...
%freq,frbw,freq_low,freq_up,cnmo,t0,rmx] = s21_1_10_50_3layrg_b_geo();
...
for ir = 1:nr	% loop over shots (ranges)
    ...
    status(:,ir)] = rayfast(paths,z,c,zs,zr,x.r(ir),r_tol);
...
[figh_tr] = raw_plot(x, t_lim, 4e2,tnmo,cnmo,fig);
saveas(figh_tr,tr_file,'epsc2');
fig = fig+1;

if(trial == 1)
    [figh_red] = reduce_sqrt(x,tsq_lim,4e3,tnmo,tsq2,cnmo,fig);
