...
%% 46
s = fgets(fid); %% dVs:       Buffer length for adapting step size
dVs = sscanf(s, '%f'); % convert to number
%% 47
s = fgets(fid); %% dVpVs:       Buffer length for adapting step size
dVpVs = sscanf(s, '%f'); % convert to number
%% 48
