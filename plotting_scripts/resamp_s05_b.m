...
outfile  = strcat('x_s05_1_6_32_0lay.mat');
outfilea = strcat('x_s05_1_6_32_0lay.txt');

nang_re = 130;
load blje5_5_bl_ping_idaB_nb.mat;

%idx = [15,19,24,31,39,49,63];
idx = [11,15,19,24,31,39,49,63];
%idx = [9,11,15,19,24,31,39,49,63];
%idx = [7,9,11,15,19,24,31,39,49,63];
nf = length(idx);
theta = xbl.ang(1:225)';
R = xbl.bl(idx,1:225);
R = R';
...
maxlim = [1.4, 1550, 1550, 1.6, 1.8, 1.000, 1.000];
