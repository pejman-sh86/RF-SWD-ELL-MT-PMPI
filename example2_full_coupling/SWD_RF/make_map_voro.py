...
vel_ref_file = filebase+'_vel_ref.txt'
NVELREF = 4

#interfaces = np.loadtxt('unique_interfaces.dat').reshape(-1)
#interfaces = np.array([0., 1., 8., 35, 170.])
interfaces = np.array([0., 40., 100., 200.])
...
#Vs = np.array([2., 3.2, 3.8, 4.7, 4.5])
Vs = np.array([3.2, 4.2, 4.6, 4.2])
