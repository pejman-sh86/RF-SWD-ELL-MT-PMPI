...
CHARACTER(LEN=100)    :: infilesample, postpredfile
TYPE (objstruc)       :: obj
...
postpredfile = filebase(1:filebaselen) // '_' // 'postpred.dat'
OPEN(UNIT=193,FILE=postpredfile,STATUS='REPLACE',ACTION='WRITE')
...
DO
    ...
    ELSE
        ...
        WRITE(193,208) Dpred
        IF (MOD(ismp,100)==0) PRINT*, 'Done writing predicted data for sample NO.: ', ismp 
